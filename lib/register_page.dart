          ...
          child: Form(
            child: Column(
              children: <Widget>[
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            setState(() {
                              var reg =
                                  RegExp(r'^[A-Za-z]{1}[A-Za-z0-9]{6,12}$');
                ...
                SizedBox(height: 15),
                Material(
                  color: _required["id"] && _required["pw"] && _required["name"]
                      ? primaryColor
                      : Color(0xFFE1E1E1),
                  borderRadius: BorderRadius.circular(10.0),
                  child: InkWell(
                    borderRadius: BorderRadius.circular(10.0),
                    onTap:
                        _required["id"] && _required["pw"] && _required["name"]
                            ? () async {
                                setState(() {
                                  _inAsyncCall = true;
                                });
                                ...
                                bool registerResult =
                                    await userStatus.register(id, pw, name);
